...
<head>
    ...
    <!-- Basic Page Needs -->
    <meta charset="utf-8">
    <title>Cuenta cuentos club - @yield('title')</title>
    <meta name="description" content="Red de personas que disfrutamos leer y compartir las lecturas con otras personas.">
                                    ...
                                    <nav id="menu" class="menu-main-menu-container">
                                        <ul id="menu-main-menu" class="menu">
                                            <li id="menu-item-18" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-2 current_page_item">
                                                <a href="index-buddy.html"><span>Inicio</span></a>
                                            </li>
                                            <li id="menu-item-39" class="menu-item menu-item-type-post_type menu-item-object-page">
                                                <a href="content/buddy/activity.html"><span>Activity</span></a>
                                            </li>
                                            <li id="menu-item-38" class="menu-item menu-item-type-post_type menu-item-object-page">
                                                <a href="content/buddy/members.html"><span>Members</span></a>
                                            </li>
                                            <li id="menu-item-37" class="menu-item menu-item-type-post_type menu-item-object-page">
                                                <a href="content/buddy/faq.html"><span>FAQ</span></a>
                                            </li>
                                            <li id="menu-item-36" class="menu-item menu-item-type-post_type menu-item-object-page">
                                                <a href="content/buddy/about-us.html"><span>About us</span></a>
                                            </li>
                                            <li id="menu-item-62" class="menu-item menu-item-type-custom menu-item-object-custom">
